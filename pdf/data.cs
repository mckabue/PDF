...
namespace pdf
{
    public class data
    {
        public List<data> Questions()
        {
            ...
            questions.Add(new data { QuestionID = "1", Message = "<span><b>bold</b> and <em>hardsome</em> plus image</span>" });
            ...
            questions.Add(new data { QuestionID = "9", Message = "<span><b>bold</b> and <em>hardsome</em> plus image</span>" });
            questions.Add(new data { QuestionID = "10", Message = "<span><b>bold</b> and <em>hardsome</em> plus image</span>" });
